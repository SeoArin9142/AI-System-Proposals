...
1. **단기**: 내부 통제는 유지하되, 외부 Reviewer를 제한적으로 활용
...
- 보안, 비용, 구축 속도를 모두 고려한 **사내 AI 구축 방식 선택** 필요
...
- 개발 생산성 향상
- 리뷰 및 테스트 검토 체계화
- 지식 자산화(규칙 카드, benchmark)
- 도입 단계에 따라 비용/보안/속도 균형 선택 가능
...
### 제안
- **단기**: 보수형 하이브리드로 빠른 파일럿
- **중장기**: 완전 폐쇄형으로 단계 이행
- 저장소 1개, 팀 1개 기준 MVP부터 시작

### 회의용 한 줄
사내 AI를 한 번에 한 방식으로 고정하자는 것이 아니라, **보안·비용·속도 기준으로 완전 폐쇄형 / 외부망 연동형 / 하이브리드형을 비교하고, 단기에는 보수형 하이브리드로 시작해 중장기적으로 완전 폐쇄형으로 가자는 제안**입니다.
